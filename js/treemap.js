/*
	Adapted from  http://bost.ocks.org/mike/treemap/
	Author: Mike Bostock
*/
...
d3.json("./data/data.json", function(root) {
	...
	function display(d) {
		...
		g.selectAll(".child")
			...
			.enter().append("rect")
			.attr("class", "child")
			.attr("fill", function(d) {return themeColor[Math.round(d.level/100)]; })
			.attr("opacity", function(d) {return visibility[d.level%100]; })
			.call(rect);
